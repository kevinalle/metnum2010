...
%		\input{resultados_bomba.tex}
	...
	\begin{usection}{Discusión}
		...
		\begin{usubsection}{Error}
			...
			En los dos ultimos casos de al figura \ref{res_ej1_err} vemos
			como el error evoluciona de manera pareja en función del tiempo,
			lo que parece indicar un buen funcionamiento del algoritmo, ya que no hay saltos bruscos,
			excepto los de la posición del sol para los cuáles no hemos encontrado aún una explicación.
			
			Los errores se deben seguramente a la diferencia de presición en el cálculo con respecto a los cómputos de la NASA,
			...
			En los gráficos de la tierra y la luna podemos ver que se producen osilaciones
			que curiosamente tienen un peíodo de 365 días.
			Si buscamos la causa en los gráficos de órbitas, vemos que a medida que
