...
sol =		Cuerpo("Sol",    1.9891,        V3(-4.042895106228434e-03, 2.209532530800580e-03, 1.136425407067405e-05),  V3(-1.786236608923230e-06, -5.959144368171789e-06, 4.287462284225408e-08), (.8,.8,.0))
tierra =	Cuerpo("Tierra", 0.0000059736,  V3(-7.262551982062518e-01, -7.016177342125620e-01, 2.942601923402196e-05), V3(1.172032570433690e-02, -1.239499064419012e-02, -2.875393960566639e-07), (.1,.7,.2))
luna =	Cuerpo("Luna", 0.00000007349,   V3(-7.248557601516714e-01, -7.039097848869444e-01, 1.029051462977911e-04), V3(1.220576787081027e-02, -1.211595432894550e-02, 4.775108508860639e-05), (.7,.7,.7))
mercurio=Cuerpo("Mercurio", 0.0000003302,V3(-2.563687782457914E-01, -3.810998677594219E-01, -8.153193298845162E-03),V3(1.781451838572982E-02, -1.414097937982711E-02, -2.789632381177015E-03), (1.,.2,.2))
venus =  Cuerpo("Venus", 0.0000048685,   V3(-2.745105890947935E-01, 6.675955871621595E-01, 2.473298509458710E-02),  V3(-1.880800003531344E-02, -7.736184882354628E-03, 9.795183384655537E-04), (.3,.8,.7))
marte =  Cuerpo("Marte", 0.00000064185,  V3(-1.644799113455717E+00, 2.491823732968801E-01, 4.547552485947825E-02),  V3(-1.562104985945559E-03, -1.264976840237743E-02, -2.265804582138816E-04), (.7,.0,.0))
jupiter =Cuerpo("Jupiter", 0.00189813,   V3(4.814383212086098E+00, -1.241505788193773E+00, -1.026521185883739E-01), V3(1.791829827597031E-03, 7.666882051378563E-03, -7.193518744890309E-05), (.5,.5,.0))
saturno =Cuerpo("Saturno", 0.000568319,  V3(-9.498834472404264E+00, -4.314789953129710E-01, 3.854986365834464E-01), V3(-4.474247412442582E-05, -5.585253179574848E-03, 9.894753356331143E-05), (.3,.3,.0))
...
def render_2d():
	...
	for c in N:
		...
		plot(posiciones[c][-1][0],posiciones[c][-1][1], 'o', color=cuerpos[c].color, mew=0)
